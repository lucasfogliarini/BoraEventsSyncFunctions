...
namespace BoraEventsSyncFunctions.MinhaEntrada
{
	public class MinhaEntradaCrawler
	{
        ...
        public async Task<List<MinhaEntradaEvent>> CrawlEventsAsync(DateTime? startDate = null, DateTime? endDate = null)
		{
		...
		private static List<MinhaEntradaEvent> ExtractEvents(IDocument document)
		{
			var events = document.QuerySelectorAll(".card-agenda-geral");

			List<MinhaEntradaEvent> eventList = new();
